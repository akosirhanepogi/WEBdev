...
<head>
    ...
    <title>MJeshter Fitness</title>
</head>
<body>
    <!-- Navigation -->
    <nav>
        <div class="nav__logo">
            <a href="#home"><img src="assets/logogym.jpg" alt="MJeshter Logo" /></a>
        </div>
        <ul class="nav__links">
        ...
        <a href="login.php" class="btnn" id="joinNowBtn">Join Now</a>
    </nav>
    ...
    <header id="home" class="section__container header__container">
        <div class="header__content">
            ...
            <p>
                ...
                fitter, and more confident you. Sign up now and witness the incredible 
                transformation your body is capable of!
            </p>
            <a href="login.php" class="btnd" id="joinNowBtn">GET STARTED</a>
        </div>
        <div class="header__image">
            <img src="assets/header.png" alt="Fitness Header" />
        </div>
    </header>
    ...
    <section id="program" class="section__container explore__container">
        ...
        <div class="explore__grid">
            <div class="explore__card">
                ...
                <a href="login.php" class="program-join-btn">Join Now <i class="ri-arrow-right-line"></i></a>
            </div>
            <div class="explore__card">
    ...
    <!-- Class Section -->
    <section id="class" class="section__container class__container">
        <div class="class__image">
            <span class="bg__blur"></span>
            <img src="assets/class-1.jpg" alt="Class 1" class="class__img-1" />
            <img src="assets/class-2.jpg" alt="Class 2" class="class__img-2" />
        </div>
        <div class="class__content">
            ...
            <a href="login.php" class="btnd" id="bookClassBtn">Book A Class </a>
        </div>
    </section>

    <!-- Join Us Section -->
    <section id="community" class="section__container join__container">
        ...
        <div class="join__image">
            <img src="assets/join.jpg" alt="Join Community" />
    ...
    <!-- Pricing Section -->
    <section id="service" class="section__container price__container">
        ...
        <div class="price__grid">
            <div class="price__card">
                ...
                <a href="login.php" class="btnd price__btn" data-plan="basic">Join Now</a>
            </div>
            <div class="price__card">
                <div class="price__card__content">
                    <h4>Weekly Plan</h4>
                ...
                <a href="login.php" class="btnd price__btn" data-plan="Weekly">Join Now</a>
            </div>
            <div class="price__card">
                <div class="price__card__content">
                    <h4>Monthly Plan</h4>
                ...
                <a href="login.php" class="btnd price__btn" data-plan="Monthly">Join Now</a>
            </div>
        </div>
    </section>
            ...
            <div class="review__content">
                ...
                <div class="review__footer">
                    ...
                    <div class="review__nav">
                        <span id="reviewPrev"><i class="ri-arrow-left-line"></i></span>
                        <span id="reviewNext"><i class="ri-arrow-right-line"></i></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer__bar">
        Copyright © 2023 MJeshter Fitness. All rights reserved.
    </div>
